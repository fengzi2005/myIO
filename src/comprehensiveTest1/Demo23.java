...
public class Demo23 {
    public static void main(String[] args) throws IOException {
        ...
        //读取网站内容
        String firstNamestr = getString(url1);
        String boyNamestr = getString(url2);
        ...
        ArrayList<String> girlNameTemplist = getInfo(girlNamestr,Pattern.compile("((([\\u4E00-\\u9FA5]{2})(、)){4}[\\u4E00-\\u9FA5]{2})"));
        ...
        //创建文件对象
        File file = FileUtil.file(new File("src/comprehensiveDemo"), "name1.txt");
        //写入文件
